...
This chapter lists all programmable logic elements used on the board.
For PROMs, the source, hex, and timing files are listed.
PALs are included in their source file only.
...
This chapter contains the schematics and listings derived from it.
The listings are the parts list, the wirelist summary, and the actual wirelist.
